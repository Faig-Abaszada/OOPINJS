...
function Circle(radius) {
  let color = "red";
  // Because were we are using a variable, instead of the "this" keyword,
  // color it is not a property from this object, so it is not accessible from the outside.
  // It is only a variable with local scope to this function.
  this.radius = radius;
...
// The defaultLocation and computeOptimumLocation are in the scope of the Circle function and the clojure fo the draw function.
